// ==UserScript==
// @name         Mope.io ZOOM HACK - Mopeio Hacks - Best Mope Cheat 2019 to 2020
...
// @updateURL    https://io-mods.com/mods/mopeio.user.js
// @downloadURL  https://io-mods.com/mods/mopeio.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://mope.io/*
// @match        *://beta.mope.io/*
...
text += '<a href="http://'+value+'" target="_blank" style="'+ministyler+'">'+value2+' <font color="#555555">-</font></a>';
    ...
    //ozellikler
    var fts = ["Zoom Hack","Speed Hack","Level Hack","Aimbot","Auto Aim","Auto Heal","Anti Lag","Anti Ads","Quick Level","Auto Feed","Auto Spawn"];
...
//degisenkisimlar
$('#mopeMenu').prepend('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('#moneyRect').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
...
var cursorRefresh = function() { document.getElementById("gCanvas").style.cursor = cursorStyle; };
...
window.onmousemove = function() { if ( document.getElementById("gCanvas").style.cursor != cursorStyle ) { cursorStyle = document.getElementById('cursor-game').options[document.getElementById('cursor-game').selectedIndex].value; cursorRefresh(); } };
    document.body.style.cursor = document.getElementById('cursor-game').options[document.getElementById('cursor-game').selectedIndex].value;
	    document.button.style.cursor = document.getElementById('cursor-game').options[document.getElementById('cursor-game').selectedIndex].value;
...
function changebackground() {
    ...
    var rgbaC2 = 'rgba(' + parseInt(changecolor.slice(-6, -4), 16) + ',' + parseInt(changecolor.slice(-4, -2), 16) + ',' + parseInt(changecolor.slice(-2), 16) + ',0.35)';
             $('#mopeMenu').css('background-color',rgbaC2);
         $('#startMenu').css('background-color',rgbaC2);
$('#ytDiv').css('background-color',rgbaC2);
    $('#updatesDiv').css('background-color',rgbaC2);
}
...
$('#mopeMenu').css('background-color',rgbaCol);
         $('#startMenu').css('background-color',rgbaCol);
$('#ytDiv').css('background-color',rgbaCol);
    $('#updatesDiv').css('background-color',rgbaCol);
      }, 3000);
}
